...
use rubencm\storage_flysystem\stream_interface;
use rubencm\storage_flysystem\exception\exception;
...
class local implements adapter_interface, stream_interface
{
	 ...
	 *
	 * @throws \rubencm\storage_flysystem\exception\exception	On any directory creation failure
	 */
	 ...
	 *
	 * @throws \rubencm\storage_flysystem\exception\exception		When cannot get size
	 *
